...
removeRangerAdmin() {
    ...
    ranger-admin stop
    echo "Drop Ranger DB..."
    mysql -h$MYSQL_HOST -P$MYSQL_PORT -u$MYSQL_USER -p$MYSQL_ROOT_PASSWORD -s --prompt=nowarning --connect-expired-password -e "drop database if exists $MYSQL_RANGER_DB;"
