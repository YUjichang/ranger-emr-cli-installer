...
OPT_KEYS=(
    ...
    JAVA_HOME SKIP_INSTALL_MYSQL MYSQL_HOST MYSQL_PORT MYSQL_USER MYSQL_ROOT_PASSWORD MYSQL_RANGER_DB_USER_PASSWORD
    SKIP_INSTALL_SOLR SOLR_HOST RANGER_VERSION RANGER_PLUGINS
