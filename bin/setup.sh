...
DEFAULT_DB_RANGER_NAME='ranger'
DEFAULT_DB_RANGER_USER='ranger'
...
OPT_KEYS=(
    ...
    JAVA_HOME SKIP_INSTALL_MYSQL MYSQL_HOST MYSQL_PORT MYSQL_USER MYSQL_ROOT_PASSWORD MYSQL_RANGER_DB_USER_PASSWORD MYSQL_RANGER_DB
    MYSQL_RANGER_DB_USER SKIP_INSTALL_SOLR SOLR_HOST RANGER_VERSION RANGER_PLUGINS
